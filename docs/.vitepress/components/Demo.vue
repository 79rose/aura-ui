...
<template>
  <div class="demo">
    ...
    <div class="demo-operators">
      <i class="i-au-code-screen" title="在 Playground 中编辑" @click="toPlayground" />
      <i class="i-au-code" title="查看源代码" @click="isCodeShow = !isCodeShow" />
    </div>
...
.demo {
  border: 1px solid rgb(var(--au-color-bd_light));
  border-radius: 4px;
}
...
.demo-operators {
  ...
  padding: 16px;
  font-size: 18px;
  color: rgb(var(--au-color-secondary));
  border-top: 1px solid rgb(var(--au-color-bd_light));
