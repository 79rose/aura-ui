...
const secondLineThemeVars: AurauiCssVarsConfig = reactive({});
// 局部主题切换
...
<template>
  <div>
    ...
    <div>
      <i class="i-au-alert text-100px c-primary inline-block" />
      <i class="i-au-alert-marked text-60px c-success inline-block" />
    </div>
    <Input />
  </div>
</template>
