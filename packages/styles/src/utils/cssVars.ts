...
export type DefaultPrefix = 'au-';
/** 默认情况下，生成 CSS 变量时增加的前缀 */
export const DEFAULT_PREFIX: DefaultPrefix = 'au-';
 ...
 */
export interface GenerateCssVarsautions<
  K = string,
 ...
 * CSS 变量对象的类型
 * @typeParam T 原始对象的类型
 * @typeParam {@link GenerateCssVarsautions}
 */
 ...
 * @param autions 选项 {@link GenerateCssVarsautions}
 */
...
>(
  origin: T,
  autions?: GenerateCssVarsautions<K, P>,
): CssVarsObject<T, K, P> {
  const {
