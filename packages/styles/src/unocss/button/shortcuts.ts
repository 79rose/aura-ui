...
export const buttonShortcuts: (StaticShortcut | DynamicShortcut<Theme>)[] = [
  ...
  ['au-button--disabled', `
  ${stylesToShortcuts(disabledStyle, '[&.au-button]')}
  ${stylesToShortcuts(disabledStyle, 'hover:[&.au-button]')}
  ${stylesToShortcuts(disabledStyle, 'active:[&.au-button]')}
  `],

  ['au-button--primary', `${buttonTypeStyle('primary')}`],
  ['au-button--success', `${buttonTypeStyle('success')}`],
  ['au-button--warning', `${buttonTypeStyle('warning')}`],
  ['au-button--danger', `${buttonTypeStyle('danger')}`],
  ['au-button--info', `${buttonTypeStyle('info')}`],
